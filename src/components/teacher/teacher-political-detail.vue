<template>
  <transition name="fade">
    <div>
      <div class="title">
        <router-link class="router-link" to="/home/teacher/teacher-political"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></router-link>
        <span>{{$route.params.chinaname}}</span>
      </div>
<!-- 详细内容 -->
...
export default {
  ...
  mounted() {
    this.fetchpoliticalDetail()
  },
  methods: {
    fetchpoliticalDetail() {
      this.$common.http.get(this.$common.api.TeacherInfo+'?teacher_id='+this.$route.params.politicalid)
        .then(response => {
        ...
        .catch(error => {
          ...
          this.detail.address = politicalDetail.address
          this.detail.careers = politicalDetail.careers
          this.detail.certifications = politicalDetail.certifications
          this.detail.evaluations = politicalDetail.evaluations
          this.detail.headimg = politicalDetail.headimg
          this.detail.intro = politicalDetail.intro
          this.detail.phone = politicalDetail.phone
          this.detail.submark = politicalDetail.submark
          this.detail.intro = politicalDetail.intro
          this.detail.submarkname = Convert.convertSubNumber(politicalDetail.submark)
          this.detail.gender = politicalDetail.gender
