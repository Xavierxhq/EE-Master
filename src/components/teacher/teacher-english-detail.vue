<template>
  <transition name="fade">
    <div>
      <div class="title">
        <router-link class="router-link" to="/home/teacher/teacher-english"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></router-link>
        <span>{{$route.params.englishname}}</span>
      </div>
<!-- 详细内容 -->
...
export default {
  ...
  mounted() {
    this.fetchenglishDetail()
  },
  methods: {
    fetchenglishDetail() {
      this.$common.http.get(this.$common.api.TeacherInfo+'?teacher_id='+this.$route.params.englishid)
        .then(response => {
        ...
        .catch(error => {
          ...
          this.detail.address = englishDetail.address
          this.detail.careers = englishDetail.careers
          this.detail.certifications = englishDetail.certifications
          this.detail.evaluations = englishDetail.evaluations
          this.detail.headimg = englishDetail.headimg
          this.detail.intro = englishDetail.intro
          this.detail.phone = englishDetail.phone
          this.detail.submark = englishDetail.submark
          this.detail.intro = englishDetail.intro
          this.detail.submarkname = Convert.convertSubNumber(englishDetail.submark)
          this.detail.gender = englishDetail.gender
