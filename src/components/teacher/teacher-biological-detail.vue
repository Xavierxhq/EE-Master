<template>
  <transition name="fade">
    <div>
      <div class="title">
        <router-link class="router-link" to="/home/teacher/teacher-biological"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></router-link>
        <span>{{$route.params.biologicalname}}</span>
      </div>
<!-- 详细内容 -->
...
export default {
  ...
  mounted() {
    this.fetchbiologicalDetail()
  },
  methods: {
    fetchbiologicalDetail() {
      this.$common.http.get(this.$common.api.TeacherInfo+'?teacher_id='+this.$route.params.biologicalid)
        .then(response => {
        ...
        .catch(error => {
          ...
          this.detail.address = biologicalDetail.address
          this.detail.careers = biologicalDetail.careers
          this.detail.certifications = biologicalDetail.certifications
          this.detail.evaluations = biologicalDetail.evaluations
          this.detail.headimg = biologicalDetail.headimg
          this.detail.intro = biologicalDetail.intro
          this.detail.phone = biologicalDetail.phone
          this.detail.submark = biologicalDetail.submark
          this.detail.intro = biologicalDetail.intro
          this.detail.submarkname = Convert.convertSubNumber(biologicalDetail.submark)
          this.detail.gender = biologicalDetail.gender
