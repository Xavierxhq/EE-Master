<template>
  <transition name="fade">
    <div>
      <div class="title">
        <router-link class="router-link" to="/home/teacher/teacher-history"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></router-link>
        <span>{{$route.params.historyname}}</span>
      </div>
<!-- 详细内容 -->
...
export default {
  ...
  methods: {
    fetchhistoryDetail() {
      this.$common.http.get(this.$common.api.TeacherInfo+'?teacher_id='+this.$route.params.mathid)
        .then(response => {
        ...
        .catch(error => {
          ...
          this.detail.address = historyDetail.address
          this.detail.careers = historyDetail.careers
          this.detail.certifications = historyDetail.certifications
          this.detail.evaluations = historyDetail.evaluations
          this.detail.headimg = historyDetail.headimg
          this.detail.intro = historyDetail.intro
          this.detail.phone = historyDetail.phone
          this.detail.submark = historyDetail.submark
          this.detail.intro = historyDetail.intro
          this.detail.submarkname = Convert.convertSubNumber(historyDetail.submark)
          this.detail.gender = historyDetail.gender
