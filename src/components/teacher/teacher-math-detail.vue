<template>
  <transition name="fade">
    <div>
      <div class="title">
        <router-link class="router-link" to="/home/teacher/teacher-math"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></router-link>
        <span>{{$route.params.mathname}}</span>
      </div>
<!-- 详细内容 -->
    ...
    fetchmathDetail() {
      this.$common.http.get(this.$common.api.TeacherInfo+'?teacher_id='+this.$route.params.mathid)
        ...
        .catch(error => {
          ...
          this.detail.address = mathDetail.address
          this.detail.careers = mathDetail.careers
          this.detail.certifications = mathDetail.certifications
          this.detail.evaluations = mathDetail.evaluations
          this.detail.headimg = mathDetail.headimg
          this.detail.intro = mathDetail.intro
          this.detail.phone = mathDetail.phone
          this.detail.submark = mathDetail.submark
          this.detail.intro = mathDetail.intro
          this.detail.submarkname = Convert.convertSubNumber(mathDetail.submark)
          this.detail.gender = mathDetail.gender
