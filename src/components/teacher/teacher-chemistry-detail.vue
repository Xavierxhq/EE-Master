<template>
  <transition name="fade">
    <div>
      <div class="title">
        <router-link class="router-link" to="/home/teacher/teacher-chemistry"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></router-link>
        <span>{{$route.params.chemistryname}}</span>
      </div>
<!-- 详细内容 -->
...
export default {
  ...
  mounted() {
    this.fetchchemistryDetail()
  },
  methods: {
    fetchchemistryDetail() {
      this.$common.http.get(this.$common.api.TeacherInfo+'?teacher_id='+this.$route.params.chemistryid)
        .then(response => {
        ...
        .catch(error => {
          ...
          this.detail.address = chemistryDetail.address
          this.detail.careers = chemistryDetail.careers
          this.detail.certifications = chemistryDetail.certifications
          this.detail.evaluations = chemistryDetail.evaluations
          this.detail.headimg = chemistryDetail.headimg
          this.detail.intro = chemistryDetail.intro
          this.detail.phone = chemistryDetail.phone
          this.detail.submark = chemistryDetail.submark
          this.detail.intro = chemistryDetail.intro
          this.detail.submarkname = Convert.convertSubNumber(chemistryDetail.submark)
          this.detail.gender = chemistryDetail.gender
